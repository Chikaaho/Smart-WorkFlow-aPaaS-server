...
public class FormExtDatasourceQueryAdapter implements ExtDatasourceQueryPort {
    ...
    @Override
    public ExtQueryResult executeQuery(Long datasourceId, String sql, Long operatorId, String operatorName) {
        SqlExecutionResult result = sqlExecutor.execute(datasourceId, sql, operatorId, operatorName);
        return ExtQueryResult.builder()
